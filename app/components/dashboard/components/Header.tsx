...
const Header = () => {
  ...
  return (
    <header className=" h-16 items-center relative shadow w-full z-12 md:h-20 lg:rounded-2xl bg-white">
        ...
        <div className="flex items-center pl-1 relative w-full sm:pr-2 sm:ml-0 lg:max-w-68">
          <div className="flex h-full left-0 relative w-3/4">
            ...
            <div className="flex group h-full items-center relative w-36 lg:w-64">
              <div className="absolute cursor-pointer flex h-10 items-center justify-center p-3 pr-2 text-gray-500 text-sm uppercase w-auto sm:hidden">
                <svg
                  fill="none"
